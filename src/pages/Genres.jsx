...
const Genres = () => {
    ...
    //What this does is it checks that if the current thing that was clicked was the handle, it makes that the handle variable, otherwise, if we clicked within the
    //handle, then the parent of the thing we clicked on is the handle. Once the handle is not equal to null, it runs the handleClick function
